...
db.version(1).stores({
    	 ...
    	 focals: '++id,name',
    	 megapixels: '++id,name',
    	 desktops:'++id,region,department,pc_model,pc_serial,monitor_model,monitor_serial,ip,keyboard,mouse,comp_name,os,os_status,processor,ram,ms_office,ms_status,rem_storage,printer_model,printer_serial,scanner_model,scanner_serial,ups_model,tech_name,date,log',
         laptops:'++id,region,department,pc_model,pc_serial,keyboard,mouse,comp_name,os,os_status,processor,ram,ms_office,ms_status,ip,rem_storage,printer_model,printer_serial,scanner_model,scanner_serial,tech_name,date,log',
