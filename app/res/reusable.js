...
db.version(1).stores({
    	 ...
    	 servers:'++id,region,department,pc_model,pc_serial,monitor_model,monitor_serial,ip,keyboard,mouse,comp_name,os,os_status,processor,ram,ms_office,ms_status,rem_storage,ups_model,tech_name,date,log',
