...
db.version(1).stores({
    	 ...
    	 megapixels: '++id,name',
         device_type: '++id,name',
    	 desktops:'++id,region,department,pc_model,pc_serial,monitor_model,monitor_serial,ip,keyboard,mouse,comp_name,client,os,os_status,processor,ram,ms_office,ms_status,rem_storage,printer_model,printer_serial,printer_ip,scanner_model,scanner_serial,ups_model,tech_name,date,log',
         ...
         phones:'++id,region,department,phone_model,phone_serial,ip,tech_name,date',
         tablets:'++id,region,department,tablet_model,tablet_serial,ip,tech_name,date',
         ...
         extras:'++id,region,department,device_type,device_name,device_model,device_serial,ip,tech_name,date,log',
