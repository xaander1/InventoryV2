...
db.version(1).stores({
    	 ...
    	 routers:'++id,region,department,router_model,router_serial,ups_model,tech_name,date',
         accesspoints:'++id,region,department,ap_model,ap_serial,ups_model,tech_name,date,log',
         printers:'++id,region,department,printer_model,printer_serial,tech_name,date,log',
         extras:'++id,region,department,device_name,device_model,device_serial,tech_name,date,log',
